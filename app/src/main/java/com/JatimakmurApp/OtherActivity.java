...
public class OtherActivity extends AppCompatActivity implements ProdukAdapter.ItemClickListener {
    ...
    private void buttonListener() {
        ...
        btn_checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cart.isEmpty()){
                    Toast.makeText(OtherActivity .this,"Pilih barang terlebih dahulu", Toast.LENGTH_LONG).show();
                }else{
                    startActivity(new Intent(OtherActivity .this, OngkirActivity.class));
                }
            }
        });
        ...
        btnBuah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(OtherActivity .this, BuahActivity.class));
            }
        });
        ...
        btnSayur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OtherActivity .this, SayurActivity.class));
            }
        });
        ...
        btnDaging.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OtherActivity .this, DagingActivity.class));
            }
        });
        ...
        btnTelur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OtherActivity .this, TelurActivity.class));
            }
        });
        ...
        btnSusu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(OtherActivity .this, SusuActivity.class));
            }
        });
    ...
    public void onClick(View view, int position) {
        ...
        switch (view.getId()) {
            case R.id.img_card:
                ...
                return;
            default:
                Intent intent = new Intent(OtherActivity .this, DetailProdukActivity.class);
