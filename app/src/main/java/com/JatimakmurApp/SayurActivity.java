...
public class SayurActivity extends AppCompatActivity implements ProdukAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(SayurActivity.this);
        ...
        tv_category.setText("Kategori Sayur");
    ...
    private void buttonListener() {
        ...
        btn_checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cart.isEmpty()){
                    Toast.makeText(SayurActivity.this,"Pilih barang terlebih dahulu", Toast.LENGTH_LONG).show();
                }else{
                    startActivity(new Intent(SayurActivity.this, OngkirActivity.class));
                }
            }
        });
        ...
        btnBuah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SayurActivity.this, BuahActivity.class));
            }
        });
        ...
        btnSayur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SayurActivity.this, SayurActivity.class));
            }
        });
        ...
        btnDaging.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SayurActivity.this, DagingActivity.class));
            }
        });
        ...
        btnTelur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SayurActivity.this, TelurActivity.class));
            }
        });
        ...
        btnSusu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SayurActivity.this, SusuActivity.class));
            }
        });
        ...
        btnLainnya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SayurActivity.this, OtherActivity.class));
            }
        });
    ...
    public void onClick(View view, int position) {
        ...
        switch (view.getId()) {
            case R.id.img_card:
                ...
                return;
            default:
                Intent intent = new Intent(SayurActivity.this, DetailProdukActivity.class);
