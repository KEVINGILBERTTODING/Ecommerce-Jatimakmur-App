...
public class SusuActivity extends AppCompatActivity implements ProdukAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(SusuActivity.this);
    ...
    private void buttonListener() {
        ...
        btn_checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cart.isEmpty()){
                    Toast.makeText(SusuActivity.this,"Pilih barang terlebih dahulu", Toast.LENGTH_LONG).show();
                }else{
                    startActivity(new Intent(SusuActivity.this, OngkirActivity.class));
                }
            }
        });
        ...
        btnBuah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SusuActivity.this, BuahActivity.class));
            }
        });
        ...
        btnSayur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SusuActivity.this, SayurActivity.class));
            }
        });
        ...
        btnDaging.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SusuActivity.this, DagingActivity.class));
            }
        });
        ...
        btnTelur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SusuActivity.this, TelurActivity.class));
            }
        });
        ...
        btnSusu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SusuActivity.this, SusuActivity.class));
            }
        });
        ...
        btnLainnya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SusuActivity.this, OtherActivity.class));
            }
        });
    ...
    public void onClick(View view, int position) {
        ...
        switch (view.getId()) {
            case R.id.img_card:
                ...
                return;
            default:
                Intent intent = new Intent(SusuActivity.this, DetailProdukActivity.class);
