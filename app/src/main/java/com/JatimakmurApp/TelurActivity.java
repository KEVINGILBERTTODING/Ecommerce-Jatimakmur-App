...
public class TelurActivity extends AppCompatActivity implements ProdukAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(TelurActivity.this);
    ...
    private void buttonListener() {
        ...
        btn_checkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cart.isEmpty()){
                    Toast.makeText(TelurActivity.this,"Pilih barang terlebih dahulu", Toast.LENGTH_LONG).show();
                }else{
                    startActivity(new Intent(TelurActivity.this, OngkirActivity.class));
                }
            }
        });
        ...
        btnBuah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TelurActivity.this, BuahActivity.class));
            }
        });
        ...
        btnSayur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelurActivity.this, SayurActivity.class));
            }
        });
        ...
        btnDaging.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelurActivity.this, DagingActivity.class));
            }
        });
        ...
        btnTelur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelurActivity.this, TelurActivity.class));
            }
        });
        ...
        btnSusu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelurActivity.this, SusuActivity.class));
            }
        });
        ...
        btnLainnya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TelurActivity.this, OtherActivity.class));
            }
        });
    ...
    public void onClick(View view, int position) {
        ...
        switch (view.getId()) {
            case R.id.img_card:
                ...
                return;
            default:
                Intent intent = new Intent(TelurActivity.this, DetailProdukActivity.class);
