...
import com.kevin.jatimakmur.OngkirApi.OngkirActivity;
...
import static com.kevin.jatimakmur.LoginActivity.TAG_USERNAME;
...
public class MainActivity extends AppCompatActivity implements ProdukAdapter.ItemClickListener {
    ...
    private void loadJson(){
        ...
        com.kevin.jatimakmur.Util.AppController.getInstance().addToRequestQueue(reqData);
    }
