package com.kevin.jatimakmur.OngkirApi;
...
import com.kevin.jatimakmur.CartAdapter;
import com.kevin.jatimakmur.MainActivity;
import com.kevin.jatimakmur.R;
import com.kevin.jatimakmur.StatusActivity;
import com.kevin.jatimakmur.Util.ServerAPI;
import com.kevin.jatimakmur.OngkirApi.adapter.CityAdapter;
import com.kevin.jatimakmur.OngkirApi.adapter.ProvinceAdapter;
import com.kevin.jatimakmur.OngkirApi.api.ApiService;
import com.kevin.jatimakmur.OngkirApi.api.ApiUrl;
import com.kevin.jatimakmur.OngkirApi.model.city.ItemCity;
import com.kevin.jatimakmur.OngkirApi.model.cost.ItemCost;
import com.kevin.jatimakmur.OngkirApi.model.province.ItemProvince;
import com.kevin.jatimakmur.OngkirApi.model.province.Result;
...
import static com.kevin.jatimakmur.MainActivity.cart;
...
public class OngkirActivity extends AppCompatActivity {
    ...
    private List<com.kevin.jatimakmur.OngkirApi.model.city.Result> ListCity = new ArrayList<com.kevin.jatimakmur.OngkirApi.model.city.Result>();
...
//
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Object o = mListView.getItemAtPosition(i);
                com.kevin.jatimakmur.OngkirApi.model.city.Result cn = (com.kevin.jatimakmur.OngkirApi.model.city.Result) o;
        ...
        call.enqueue(new Callback<ItemCity>() {
            ...
            public void onResponse(Call<ItemCity> call, Response<ItemCity> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    int count_data = response.body().getRajaongkir().getResults().size();
                    for (int a = 0; a <= count_data - 1; a++) {
                        com.kevin.jatimakmur.OngkirApi.model.city.Result itemProvince = new com.kevin.jatimakmur.OngkirApi.model.city.Result(
    ...
    public void transaksi(){
        ...
        com.kevin.jatimakmur.Util.AppController.getInstance().addToRequestQueue(strReq);
    };
